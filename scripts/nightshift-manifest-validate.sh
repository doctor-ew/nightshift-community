...
python3 "$(dirname "$0")/nightshift-behavior-proof.py" validate --config-only --project "$PROJECT" >/dev/null || fail MANIFEST_INVALID "Behavioral proof configuration is invalid"
