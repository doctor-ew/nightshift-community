FINAL BOUNDED REPAIR, COMPONENT PROPOSAL. Your assigned scope is: scripts/nightshift-provider-usage.py ONLY. Implement full Claude/Codex normalization and provider usage provenance. Other workers implement ingestion/reports and shell integration.
